 ...
 * @author lenovo
 */
public class Tips1Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        // TODO
        var dao = new BelaDiri1DAO();
        var edu = dao.getAll();
        
        definisi.setText("Menjaga kesehatan reproduksi seksual sangat penting untuk memastikan kesejahteraan dan kualitas hidup yang baik. ");
        var text = "";
        var height = 0;
        for (var e: edu) {
            height += 80;
