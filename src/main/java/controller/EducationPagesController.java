 ...
 * @author lenovo
 */
public class EducationPagesController implements Initializable {
    ...
    @FXML
    private void belaDiri(MouseEvent event) throws IOException {
        App.setRoot("belaDiriPages");
    }

    @FXML
    private void perempi(MouseEvent event) throws IOException {
        App.setRoot("perempi");
